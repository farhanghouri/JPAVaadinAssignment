...
class ImageUploader implements Receiver, SucceededListener {
    ...
    public Panel setImageUploader(){
    	       // Show uploaded file in this placeholder
    			image = new Embedded("Uploaded Image");
    			image.setVisible(false);
    			 
    			// Create the upload with a caption and set receiver later
    			Upload upload = new Upload("Upload Image Here", this);
    ...
    public OutputStream receiveUpload(String filename,
        ...
        try {
            ...
            file = new File("/Users/farhan/Documents/MAVEN/JPAVaadinAssignment/src/main/resources/images/" + filename);
